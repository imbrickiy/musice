...
abstract class AppLocalizations {
  ...
  /// No description provided for @stationsTooltip.
  ///
  /// In en, this message translates to:
  /// **'Stations'**
  String get stationsTooltip;

  /// No description provided for @stationsSemantics.
  ///
  /// In en, this message translates to:
  /// **'Open stations'**
  String get stationsSemantics;
  ...
  /// No description provided for @errorStartStream.
  ///
  /// In en, this message translates to:
