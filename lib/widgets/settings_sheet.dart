...
class SettingsSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      top: false,
      child: Padding(
        padding: kSheetPadding.add(
          const EdgeInsets.symmetric(horizontal: kHeaderHPad),
        ),
        child: Container(
              ...
              children: [
                ...
                ValueListenableBuilder<bool>(
                  ...
                  builder: (context, value, _) => SwitchListTile(
                    ...
                    dense: true,
                    title: Text(
                      l10n.autoplayOnLaunch,
                      style: kSheetListTileTextStyle,
                    ),
                    value: value,
                    onChanged: (v) =>
                        SettingsController.instance.setAutoplayOnLaunch(v),
                  ),
                ),
                ValueListenableBuilder<bool>(
                  valueListenable:
                      SettingsController.instance.rememberLastStation,
                  builder: (context, value, _) => SwitchListTile(
                    contentPadding: EdgeInsets.zero,
                    dense: true,
                    title: Text(
                      l10n.rememberLastStation,
                      style: kSheetListTileTextStyle,
                    ),
                    value: value,
                    onChanged: (v) =>
